...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../Downloads/barmm.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.apelyid_label = QtWidgets.QLabel(self.centralwidget)
        self.apelyid_label.setGeometry(QtCore.QRect(210, 490, 91, 16))
        self.apelyid_label.setObjectName("apelyid_label")
        ...
        self.searchAll_btn.setGeometry(QtCore.QRect(440, 90, 131, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.search_comboBox.setGeometry(QtCore.QRect(580, 90, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.search_edit.setGeometry(QtCore.QRect(170, 150, 211, 41))
        ...
        self.frame.setGeometry(QtCore.QRect(30, 90, 351, 41))
        self.frame.setFrameShape(QtWidgets.QFrame.Box)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")

        self.search_radioButton = QtWidgets.QRadioButton(self.frame)
        self.search_radioButton.setGeometry(QtCore.QRect(20, 10, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.searchAll_radioButton.setGeometry(QtCore.QRect(90, 10, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.searchAll_radioButton.setFont(font)
        self.searchAll_radioButton.setObjectName("searchAll_radioButton")

        self.adsearch_radioButton = QtWidgets.QRadioButton(self.frame)
        self.adsearch_radioButton.setGeometry(QtCore.QRect(180, 10, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.adsearch_radioButton.setFont(font)
        self.adsearch_radioButton.setObjectName("adsearch_radioButton")
        ...
        self.label_15.setGeometry(QtCore.QRect(1110, 30, 161, 151))
        self.label_15.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.label_15.setText("")
        self.label_15.setPixmap(QtGui.QPixmap("../../../Downloads/barmm.png"))
        ...
        self.civil_comboBox.setGeometry(QtCore.QRect(130, 580, 81, 31))
    ...
    def retranslateUi(self, MainForm):
        ...
        self.apelyid_label.setText(_translate("MainForm", "(Apelyido)"))
        ...
        self.adsearch_radioButton.setText(_translate("MainForm", "Advance Search"))
