...
class Ui_MainClear(object):
    ...
    def setupUi(self, MainClear):
        ...
        self.age_edit.setGeometry(QtCore.QRect(375, 366, 31, 20))
        ...
        self.sex_edit.setGeometry(QtCore.QRect(468, 366, 67, 20))
        ...
        self.month_edit.setGeometry(QtCore.QRect(268, 534, 151, 20))
        self.month_edit.setFrame(False)
        font = QtGui.QFont()
        #font.setPointSize(11)
        font.setBold(True)
        self.month_edit.setFont(font)
        self.month_edit.setObjectName("month_edit")
        
        self.day_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.day_edit.setGeometry(QtCore.QRect(190, 534, 31, 20))
        ...
        self.issue_edit.setGeometry(QtCore.QRect(170, 781, 91, 20))
